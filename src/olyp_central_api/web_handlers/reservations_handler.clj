                                     ...
                                     (let [line (invoices-factory/get-room-booking-invoice-line
                                       ...
                                       {"customer" (customers-handler/customer-ent-to-public-value customer)
                                        ...
                                        "line" {"total_minutes" (:total-minutes line)
                                                ...
                                                "base_sum_without_tax" (:base-sum-without-tax line)
                                                "base_sum_with_tax" (:base-sum-with-tax line)
                                                "tax" (:tax line)
                                                "sum_without_tax" (:sum-without-tax line)
                                                "sum_with_tax" (:sum-with-tax line)}}))))
